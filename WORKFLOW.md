...
- For changed plans, follow `docs/engineering/symphony/replanning.md`: do small
  node additions, deletions, or splits directly, adding a Linear ticket if
  needed. For larger changes, create a replanning ticket from the planning
  template and a dependent fan-out ticket. Preserve unresolved feedback.
