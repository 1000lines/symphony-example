...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [100-38](https://linear.app/1000lines/issue/100-38) and full project brief                                                                                   | Linear GraphQL; initial brief `2026-09-11T12:46:33.717Z`, amended for human decisions `2026-09-11T13:15:31.917Z`                                                                       | Deliver design only; small template, extraction and adoption; human merges.                                                                                                         |
...
boundary are superseded by Jeremy's 13:11 decision; the other source requirements
remain in force.
...
Run target commands against the exact PR head without reviewer secrets. Target default branch and
...
the mode field before enabling a generated config. Updating that existing reader through
...
### D7 — Onboarding skills and bounded open decision
...
| AC9  | Onboarding skill exists in symphony-example and covers fork/direct setup, repeat invocation and additional projects. Direct App/secret procedures work; fork completion remains gated only by OD1.                                                       | Onboarding skill owner/Jeremy: skill/resource paths, owner-controlled walkthrough and operation readbacks without secrets; record invocation/installed ref and OD1 dependency. No participant rehearsal claim from source alone.                                  |
...
Onboarding skill installation/invocation belongs to Jeremy; missing installation evidence gates its live walkthrough only. Required mode behavior is fixed by D8; actual toolchains, Dockerfiles and CI checks are target execution inputs.
