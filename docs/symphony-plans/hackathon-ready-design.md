...
- **S03:** [MIGRATION.md](../../MIGRATION.md), [root WORKFLOW.md at the planning baseline](https://github.com/1000lines/symphony-example/blob/9673504cfc0c96e11a8de79c9a0247ec53827f7f/WORKFLOW.md)
  ...
  authoritative source for current edits; the root link preserves historical
  input and is not a current startup path.
