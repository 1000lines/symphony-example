# Add renewable App credentials and explicit actor identities

<!-- generated-node:HR-APP:start -->

## Summary

Implement installation-token acquisition and renewal for Git askpass, gh wrappers and direct API clients. Replace required PAT/user-prefix and org-team assumptions with configured App IDs and explicit human mapping; retain the working deployment until DEPLOY.

## Plan reference

Manifest node: `APP`. Payload key: `HR-APP`.

- [Accepted plan](https://github.com/1000lines/symphony-example/blob/8f4eafe3999040f67cd68e696e29bcb27eb44149/docs/symphony-plans/fan-out-plan-100-7-hackathon-ready.md#manifest-and-branch-manifest)
- [Fan-out record: 100-8](https://linear.app/1000lines/issue/100-8/trigger-fan-out)
- [Accepted node fields](https://github.com/1000lines/symphony-example/blob/8f4eafe3999040f67cd68e696e29bcb27eb44149/docs/symphony-plans/hackathon-ready/preparation-items.md#app)
- [Execution contract](https://github.com/1000lines/symphony-example/blob/8f4eafe3999040f67cd68e696e29bcb27eb44149/docs/symphony-plans/hackathon-ready/execution-contract.md)
- [Plan validation and renderer limits](https://github.com/1000lines/symphony-example/blob/8f4eafe3999040f67cd68e696e29bcb27eb44149/docs/symphony-plans/hackathon-ready/plan-validation.md)
- [Requirements and design](https://github.com/1000lines/symphony-example/blob/8f4eafe3999040f67cd68e696e29bcb27eb44149/docs/symphony-plans/hackathon-ready-design.md); [design baseline named by source_notes](https://github.com/1000lines/symphony-example/blob/dc71026c35b7fc97f58e54cd03ce7fe513621e1f/docs/symphony-plans/hackathon-ready-design.md)
- [Authoritative brief](https://github.com/1000lines/symphony-example/blob/9673504cfc0c96e11a8de79c9a0247ec53827f7f/docs/symphony-plans/hackathon-ready-brief.md)
...
- R03/R04/D02: exact-repository/permission tokens; refresh five minutes before one-hour expiry; serialized refresh and one expiry retry after write readback.
- Expired/revoked/suspended/unselected/denied grants fail closed without PAT fallback; no secrets in URLs/logs; long-lived worker clients obtain fresh tokens.
- Materializer supports App mode without GITHUB_TOKEN; provider/Linear fields remain preserved; both actor identities and numeric issue label helper work.

## validation_commands

```bash
node --test scripts/symphony/github-app-auth.test.mjs scripts/symphony/setup-local-env.test.mjs scripts/symphony/host/ensure-pr-labels.test.mjs scripts/github-actor-classification.test.mjs scripts/symphony/host/lib.test.mjs
```
...
- [100-10](https://linear.app/1000lines/issue/100-10/bootstrap-ci-for-every-controller-change)

## Directly blocked issues

- [100-14](https://linear.app/1000lines/issue/100-14/build-isolated-codex-assessment-and-trusted-check-publication)
- [100-15](https://linear.app/1000lines/issue/100-15/reconcile-ci-and-review-through-events-and-bounded-monitors)
- [100-16](https://linear.app/1000lines/issue/100-16/prepare-and-verify-both-app-installations-and-secret-destinations)
...
- Only mocked App/Secrets Manager endpoints and per-test credential caches; no live host, secret or App mutation.

## source_notes

- Read the accepted design at dc71026c35b7fc97f58e54cd03ce7fe513621e1f and execution-contract.md; requirement IDs below define scope.

## delivery_notes

Estimate 700–950 lines; credential-boundary. Exports getInstallationToken and an execution wrapper for later CODEX/WAIT/ROUTE; INSTALL uses its preflight. Runtime source unchanged. RETIRE owns explicit legacy-mode removal after live proof.
...
- item: CI
  ...
  reason:
    Controller CI caller accepted on main before credential integration can
    satisfy mandatory CI.
```
...
finalize_action: Remove legacy selector/path after replacement proof; preserve
  durable enabled opt-in.
```

## finalization_responsibility

RETIRE removes HACKATHON_LEGACY_AUTH from the listed seam_files; FINAL verifies absence.

## difficulty

hard

## Pinned repository document references

- [1000lines/symphony-example:README.md](https://github.com/1000lines/symphony-example/blob/8f4eafe3999040f67cd68e696e29bcb27eb44149/README.md)
- [1000lines/symphony-example:MIGRATION.md](https://github.com/1000lines/symphony-example/blob/8f4eafe3999040f67cd68e696e29bcb27eb44149/MIGRATION.md)
- [1000lines/symphony-example:WORKFLOW.md](https://github.com/1000lines/symphony-example/blob/8f4eafe3999040f67cd68e696e29bcb27eb44149/WORKFLOW.md)
- [1000lines/symphony-example:scripts/symphony/runtime-bundle/workflow/WORKFLOW.md](https://github.com/1000lines/symphony-example/blob/8f4eafe3999040f67cd68e696e29bcb27eb44149/scripts/symphony/runtime-bundle/workflow/WORKFLOW.md)
- [1000lines/symphony-example:docs/engineering/symphony/project-workflow.md](https://github.com/1000lines/symphony-example/blob/8f4eafe3999040f67cd68e696e29bcb27eb44149/docs/engineering/symphony/project-workflow.md)
- [1000lines/symphony-example:docs/engineering/symphony/proof-of-work.md](https://github.com/1000lines/symphony-example/blob/8f4eafe3999040f67cd68e696e29bcb27eb44149/docs/engineering/symphony/proof-of-work.md)

<!-- generated-node:HR-APP:end -->
...
resolved_branch: symphony/hackathon-ready/100-11/app-credentials
```

## Shared DAG metadata

Generated from accepted DAG fan-out plan https://github.com/1000lines/symphony-example/blob/8f4eafe3999040f67cd68e696e29bcb27eb44149/docs/symphony-plans/fan-out-plan-100-7-hackathon-ready.md.

Payload key: HR-APP. Node type: task. Difficulty: hard. Initial status: Backlog.

Project code: hackathon-ready. Project color: pink. Base branch: main.

Human lead: Jeremy Carroll.

Branch template: symphony/hackathon-ready/${issue}/app-credentials. Declared base: main. PR base: main.

GitHub PR labels: pink, symphony.

Source links: Accepted fan-out plan (https://github.com/1000lines/symphony-example/blob/8f4eafe3999040f67cd68e696e29bcb27eb44149/docs/symphony-plans/fan-out-plan-100-7-hackathon-ready.md); 100-7 (https://linear.app/1000lines/issue/100-7/plan-project-seed-ticket).
